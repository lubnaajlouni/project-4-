<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="neww_nweee_pro.WebForm1" %>
...
<body>
    ...
    <div class="header">
        <div class="logo">
            <asp:Image class="logo" ID="Image1" runat="server"  ImageUrl="~/survey.jfif"/>
        </div>
        <div class="login">
            <div class="link">   
