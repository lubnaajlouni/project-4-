...
namespace neww_nweee_pro
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        {
            string path = @"C:\Users\dell\project-4\project-4\Textfrom.txt";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string path = z[i] + localDate + ".txt";
            string path2 = localDate + ".txt";

            string p = @"C:\Users\dell\project-4\" + path;
